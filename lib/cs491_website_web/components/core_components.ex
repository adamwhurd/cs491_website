defmodule Cs491WebsiteWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(Cs491WebsiteWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(Cs491WebsiteWeb.Gettext, "errors", msg, opts)
    end
  end
