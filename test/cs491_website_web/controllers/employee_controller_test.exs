defmodule Cs491WebsiteWeb.EmployeeControllerTest do
  use Cs491WebsiteWeb.ConnCase

  import Cs491Website.HumanResourcesFixtures

  @create_attrs %{date_of_hire: ~N[2023-04-20 20:55:00], department: "some department", employee_id: 42, first_name: "some first_name", last_name: "some last_name"}
